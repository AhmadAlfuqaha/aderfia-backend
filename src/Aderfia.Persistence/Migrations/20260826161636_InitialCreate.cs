        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FreeAboveSubtotal = table.Column<long>(type: "INTEGER", nullable: true),
                    IsActive = table.Column<bool>(type: "INTEGER", nullable: false),
                    Position = table.Column<int>(type: "INTEGER", nullable: false),
                    DescriptionAr = table.Column<string>(type: "TEXT", maxLength: 400, nullable: false),
                    DescriptionEn = table.Column<string>(type: "TEXT", maxLength: 400, nullable: false),
                    EstimateAr = table.Column<string>(type: "TEXT", maxLength: 120, nullable: false),
                    EstimateEn = table.Column<string>(type: "TEXT", maxLength: 120, nullable: false),
                    NameAr = table.Column<string>(type: "TEXT", maxLength: 120, nullable: false),
                    NameEn = table.Column<string>(type: "TEXT", maxLength: 120, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IdentityUserId = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PostalCode = table.Column<string>(type: "TEXT", maxLength: 24, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    UserId = table.Column<Guid>(type: "TEXT", nullable: true),
                    AnonymousId = table.Column<string>(type: "TEXT", maxLength: 64, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ShippingLine2 = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    ShippingCity = table.Column<string>(type: "TEXT", maxLength: 120, nullable: false),
                    ShippingRegion = table.Column<string>(type: "TEXT", maxLength: 120, nullable: true),
                    ShippingPostalCode = table.Column<string>(type: "TEXT", maxLength: 24, nullable: false),
                    ShippingCountry = table.Column<string>(type: "TEXT", maxLength: 120, nullable: false),
                    ShippingPhone = table.Column<string>(type: "TEXT", maxLength: 40, nullable: true),
                    ...
                    BillingLine1 = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    BillingLine2 = table.Column<string>(type: "TEXT", maxLength: 200, nullable: true),
                    BillingCity = table.Column<string>(type: "TEXT", maxLength: 120, nullable: false),
                    BillingRegion = table.Column<string>(type: "TEXT", maxLength: 120, nullable: true),
                    BillingPostalCode = table.Column<string>(type: "TEXT", maxLength: 24, nullable: false),
                    BillingCountry = table.Column<string>(type: "TEXT", maxLength: 120, nullable: false),
                    BillingPhone = table.Column<string>(type: "TEXT", maxLength: 40, nullable: true),
                    ShippingMethodId = table.Column<Guid>(type: "TEXT", nullable: true),
                    ShippingMethodName = table.Column<string>(type: "TEXT", maxLength: 120, nullable: false),
                    PaymentIntentId = table.Column<string>(type: "TEXT", maxLength: 128, nullable: true),
                    ...
                    TrackingNumber = table.Column<string>(type: "TEXT", maxLength: 120, nullable: true),
                    CustomerNote = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: true),
                    InternalNote = table.Column<string>(type: "TEXT", maxLength: 2000, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MetaDescriptionAr = table.Column<string>(type: "TEXT", maxLength: 400, nullable: false),
                    MetaDescriptionEn = table.Column<string>(type: "TEXT", maxLength: 400, nullable: false),
                    MetaTitleAr = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    MetaTitleEn = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    ...
                    TaglineAr = table.Column<string>(type: "TEXT", maxLength: 240, nullable: false),
                    TaglineEn = table.Column<string>(type: "TEXT", maxLength: 240, nullable: false),
                    CreatedAt = table.Column<long>(type: "INTEGER", nullable: false),
                    UpdatedAt = table.Column<long>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    Slug = table.Column<string>(type: "TEXT", maxLength: 160, nullable: false),
                    HeroImageId = table.Column<Guid>(type: "TEXT", nullable: true),
                    IsFeatured = table.Column<bool>(type: "INTEGER", nullable: false),
                    Position = table.Column<int>(type: "INTEGER", nullable: false),
                    ...
                    MetaTitleAr = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    MetaTitleEn = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    SubtitleAr = table.Column<string>(type: "TEXT", maxLength: 240, nullable: false),
                    SubtitleEn = table.Column<string>(type: "TEXT", maxLength: 240, nullable: false),
                    TitleAr = table.Column<string>(type: "TEXT", maxLength: 160, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ImageStorageKey = table.Column<string>(type: "TEXT", maxLength: 512, nullable: true),
                    Quantity = table.Column<int>(type: "INTEGER", nullable: false),
                    UnitPriceAmount = table.Column<long>(type: "INTEGER", nullable: false),
                    UnitPriceCurrency = table.Column<string>(type: "TEXT", maxLength: 3, nullable: false),
                    CreatedAt = table.Column<long>(type: "INTEGER", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Position = table.Column<int>(type: "INTEGER", nullable: false),
                    LabelAr = table.Column<string>(type: "TEXT", maxLength: 40, nullable: false),
                    LabelEn = table.Column<string>(type: "TEXT", maxLength: 40, nullable: false),
                    CreatedAt = table.Column<long>(type: "INTEGER", nullable: false),
                    UpdatedAt = table.Column<long>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BlurDataUrl = table.Column<string>(type: "TEXT", maxLength: 4000, nullable: true),
                    Position = table.Column<int>(type: "INTEGER", nullable: false),
                    CollectionId = table.Column<Guid>(type: "TEXT", nullable: true),
                    AltTextAr = table.Column<string>(type: "TEXT", maxLength: 400, nullable: false),
                    AltTextEn = table.Column<string>(type: "TEXT", maxLength: 400, nullable: false),
                    CreatedAt = table.Column<long>(type: "INTEGER", nullable: false),
                    UpdatedAt = table.Column<long>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    NameEn = table.Column<string>(type: "TEXT", maxLength: 80, nullable: false),
                    CreatedAt = table.Column<long>(type: "INTEGER", nullable: false),
                    UpdatedAt = table.Column<long>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Swatch = table.Column<string>(type: "TEXT", maxLength: 9, nullable: true),
                    Position = table.Column<int>(type: "INTEGER", nullable: false),
                    ValueAr = table.Column<string>(type: "TEXT", maxLength: 120, nullable: false),
                    ValueEn = table.Column<string>(type: "TEXT", maxLength: 120, nullable: false),
                    CreatedAt = table.Column<long>(type: "INTEGER", nullable: false),
                    UpdatedAt = table.Column<long>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "TEXT", nullable: false),
                    ProductId = table.Column<Guid>(type: "TEXT", nullable: false),
                    RelatedProductId = table.Column<Guid>(type: "TEXT", nullable: false),
                    Position = table.Column<int>(type: "INTEGER", nullable: false),
                    CreatedAt = table.Column<long>(type: "INTEGER", nullable: false),
                    UpdatedAt = table.Column<long>(type: "INTEGER", nullable: true)
                },
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DefaultVariantId = table.Column<Guid>(type: "TEXT", nullable: true),
                    Dimensions_Unit = table.Column<string>(type: "TEXT", maxLength: 8, nullable: false),
                    Dimensions_Width = table.Column<decimal>(type: "TEXT", precision: 9, scale: 2, nullable: true),
                    Dimensions_Height = table.Column<decimal>(type: "TEXT", precision: 9, scale: 2, nullable: true),
                    Dimensions_Depth = table.Column<decimal>(type: "TEXT", precision: 9, scale: 2, nullable: true),
                    Dimensions_Diameter = table.Column<decimal>(type: "TEXT", precision: 9, scale: 2, nullable: true),
                    Dimensions_WeightKg = table.Column<decimal>(type: "TEXT", precision: 9, scale: 3, nullable: true),
                    IsFeatured = table.Column<bool>(type: "INTEGER", nullable: false),
                    IsPublished = table.Column<bool>(type: "INTEGER", nullable: false),
                    ...
                    IsDeleted = table.Column<bool>(type: "INTEGER", nullable: false),
                    DeletedAt = table.Column<long>(type: "INTEGER", nullable: true),
                    CareAr = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: false),
                    CareEn = table.Column<string>(type: "TEXT", maxLength: 1000, nullable: false),
                    DescriptionAr = table.Column<string>(type: "TEXT", maxLength: 4000, nullable: false),
                    DescriptionEn = table.Column<string>(type: "TEXT", maxLength: 4000, nullable: false),
                    MetaDescriptionAr = table.Column<string>(type: "TEXT", maxLength: 400, nullable: false),
                    MetaDescriptionEn = table.Column<string>(type: "TEXT", maxLength: 400, nullable: false),
                    MetaTitleAr = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    MetaTitleEn = table.Column<string>(type: "TEXT", maxLength: 200, nullable: false),
                    ...
                    StoryAr = table.Column<string>(type: "TEXT", maxLength: 4000, nullable: false),
                    StoryEn = table.Column<string>(type: "TEXT", maxLength: 4000, nullable: false),
                    TaglineAr = table.Column<string>(type: "TEXT", maxLength: 240, nullable: false),
                    TaglineEn = table.Column<string>(type: "TEXT", maxLength: 240, nullable: false),
                    CreatedAt = table.Column<long>(type: "INTEGER", nullable: false),
                    UpdatedAt = table.Column<long>(type: "INTEGER", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductId = table.Column<Guid>(type: "TEXT", nullable: false),
                    Position = table.Column<int>(type: "INTEGER", nullable: false),
                    GroupAr = table.Column<string>(type: "TEXT", maxLength: 80, nullable: false),
                    GroupEn = table.Column<string>(type: "TEXT", maxLength: 80, nullable: false),
                    LabelAr = table.Column<string>(type: "TEXT", maxLength: 120, nullable: false),
                    LabelEn = table.Column<string>(type: "TEXT", maxLength: 120, nullable: false),
                    ValueAr = table.Column<string>(type: "TEXT", maxLength: 600, nullable: false),
                    ValueEn = table.Column<string>(type: "TEXT", maxLength: 600, nullable: false),
                    CreatedAt = table.Column<long>(type: "INTEGER", nullable: false),
                    UpdatedAt = table.Column<long>(type: "INTEGER", nullable: true)
                },
                constraints: table =>
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ProductId = table.Column<Guid>(type: "TEXT", nullable: false),
                    Sku = table.Column<string>(type: "TEXT", maxLength: 64, nullable: false),
                    CompareAtAmount = table.Column<long>(type: "INTEGER", nullable: true),
                    StockQuantity = table.Column<int>(type: "INTEGER", nullable: false),
                    LowStockThreshold = table.Column<int>(type: "INTEGER", nullable: false),
                    IsMadeToOrder = table.Column<bool>(type: "INTEGER", nullable: false),
                    LeadTimeAr = table.Column<string>(type: "TEXT", maxLength: 120, nullable: false),
                    LeadTimeEn = table.Column<string>(type: "TEXT", maxLength: 120, nullable: false),
                    AllowBackorder = table.Column<bool>(type: "INTEGER", nullable: false),
                    Dimensions_Unit = table.Column<string>(type: "TEXT", maxLength: 8, nullable: true),
                    Dimensions_Width = table.Column<decimal>(type: "TEXT", precision: 9, scale: 2, nullable: true),
                    Dimensions_Height = table.Column<decimal>(type: "TEXT", precision: 9, scale: 2, nullable: true),
                    Dimensions_Depth = table.Column<decimal>(type: "TEXT", precision: 9, scale: 2, nullable: true),
                    Dimensions_Diameter = table.Column<decimal>(type: "TEXT", precision: 9, scale: 2, nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    OptionValueId = table.Column<Guid>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
